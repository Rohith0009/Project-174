...
label = Label(root, text="Assigning Jobs", font=("arial", 20))
...
label_doctor.place(anchor=CENTER, relx=0.04, rely=0.15)
...
label_IT.place(anchor=CENTER, relx=0.06, rely=0.45)
...
label_chemical.place(anchor=CENTER, relx=0.07, rely=0.75)
